...
const Navbar = () => {
  return (
    <>
      <nav className="bg-neutral-secondary-soft fixed w-full z-20 top-0 inset-s-0 border-b border-default">
        <div className="max-w-7xl flex-wrap items-center justify-between mx-auto p-4">
          <a
